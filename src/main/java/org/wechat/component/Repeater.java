...
public class Repeater {
  ...
  public String makeResponse(HashMap<String, String> hashMap) throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
    ...
    switch (hashMap.get("MsgType")) {
      case "event": dataList = eventHandler.getDataList(hashMap.get("Event"), hashMap.get("EventKey")); break;
      case "text": dataList = textHandler.getDataList(hashMap.get("Content")); break;
      case "image": break;
      case "voice": break;
      case "vedio": break;
    ...
    return messageProcessor.createMessage(hashMap, new String[]{"text", "你发的是什么啦，看不懂得啦"});
  }
}